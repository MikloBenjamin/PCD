...
public class AsyncTaskClient {
    ...
    public void clientRun() throws IOException, InterruptedException {
        ...
        System.out.println("NUMAR IMAGINI : " + photoCount);
        for (File file: photos) {
            ...
            System.out.println("The file Length is : " + (int) fileF.length());
            ...
            if ((int) firstMessageReceived[0] != 1) {
                ...
                System.out.println("Am primit the first response  " + (int) firstMessageReceived[0]);
                ...
                System.out.println("numberOfPackets((int)file.length() ============================================================================================== " + numberOfPackets((int) file.length()));
                //=====================
                int serverResponseNrPackages = 0;
                while ((read = fileInputStream.read(fileContentBytesBUFF)) > 0) {
                    // TRF. Length int to byte format

                    System.out.println("READ ::: " + read);

                    System.out.println("fileContentBytesBUFF : " + fileContentBytesBUFF.length);
                    ...
                    System.out.println("Lungimea chunk-ului este : " + read);
                    System.out.println("ProtocolMessageIs : " + byteArrayLength(protocolMessage));
                    ...
                    //Thread.sleep(1000);
                    System.out.println("SERVER RESPONSE AFTER PACKEGEEEEEEEEE : " + serverResponse[0]);
                    if ((int) serverResponse[0] == 1) {
                        System.out.println(" Am primit confirmare de la server pe partea CLIENT ---- SERVER");

                    } else if ((int) serverResponse[0] == 2) {

                        serverResponseNrPackages = serverResponse[1];
                        System.out.println();
                        System.out.println("NUMARUL DE PACHETE CARE SE VOR TRIMITE ESTE : " + serverResponseNrPackages);
                        System.out.println();
                ...
                System.out.println("INCEPE ETAPA SERVER ---> CLIENT");
                System.out.println("SERVER RESPONSE AFTER PACKEGE : " + serverResponseNrPackages);
                ...
                System.out.println("Numarul de pachete pe care clientul trebuie sa le primeasca este :" + numberOfPacketsToReceive);
                ...
                while ((read = dataInputStream.read(imageContentServer)) != 0) {
                    ...
                    packagesOf1021++;
                    System.out.println();
                    System.out.println("THE_READ_IS : " + read);
                    System.out.println("imageContentServer[0] = " + imageContentServer[0]);
                    System.out.println();
                    if (imageContentServer[0] != 3) {
                        ...
                        System.out.println("Y server is :" + number_of_packets);
                        ...
                        System.out.println("LENGTHOS : " + byteArrayOutputStreamServerMessage.size());
                ...
                System.out.println("1021 : " + packagesOf1021);
                System.out.println("PACKEGES RECEIVED = " + numberOfPacketsReceived);
                ...
                System.out.println("The Length of the new image is : " + byteArrayLength(fullImageContent));
...
//===========TEST REFACERE POZA======================
                    /*
                    fullImageContent1 =baos.toByteArray();
                    System.out.println("PHOTO Length : " + fullImageContent1.length);
                    System.out.println("fullImageContent1 [1] = " + fullImageContent1 [1]);
                    InputStream in = new ByteArrayInputStream(fullImageContent1);
                    BufferedImage image = ImageIO.read(in);
                    ImageIO.write(image, "png", new File("/home/antonio/Downloads/GKSTEST2.png") );

                    //===========

                    try (FileOutputStream fos = new FileOutputStream("/home/antonio/Downloads/GKSOutput1.png")) {
                        fos.write(fullImageContent1);
                    }
                    */

//===========TEST REFACERE POZA======================
                /*
                //fullImageContent1 = ByteBuffer.allocate(byteArrayLength(fullImageContent1) + byteArrayLength(fileContentBytesBUFF))
                  //      .put(fullImageContent1).put(fileContentBytesBUFF).array();
